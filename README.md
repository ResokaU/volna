...
| 🌴 Вайб (тикток-режим) | 🔥 Популярное сейчас |
|---|---|
| <img src="docs/app-vibe.png" width="100%"> | <img src="docs/app-trending.png" width="100%"> |

| 📝 Караоке (свой текст) | ⚙️ 18 акцентов · EQ · пульт |
|---|---|
| <img src="docs/app-karaoke.png" width="100%"> | **Своя музыка — свой визуал.** Волновая перемотка, тап-синхрон текста, 10-полосный EQ, пульт с телефона — всё внутри. |
